 ...
 * @author Virginijus
 */
class LkiSurname extends AbstractDictionary
{   
    private $_cacheDir = 'cache/LKI_SURNAME/';
    ...
    public function __construct() {
        $this->setResourceId('LKIVocabulary/9975325');
        $this->setResourceName('Pavardžių žodynas');
        
        /** @var Uri\AbstractUri $uriFactory */
        $uriFactory = new Owl\Uri\UriFactory();
        $uriFactory->setUriBase('&lmf;zodynas.Pavardžių_žodynas');
