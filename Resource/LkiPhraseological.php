 ...
 * @author Virginijus
 */
class LkiPhraseological extends AbstractDictionary
{   
    private $_cacheDir = 'cache/LKI_PHRASEOLOGICAL/';
    ...
    public function __construct() {
        $this->setResourceId('LKIVocabulary/1682745');
        $this->setResourceName('Frazeologijos žodynas');
        
        /** @var Uri\AbstractUri $uriFactory */
        $uriFactory = new Owl\Uri\UriFactory();
        $uriFactory->setUriBase('&lmf;zodynas.Frazeologijos_žodynas');
